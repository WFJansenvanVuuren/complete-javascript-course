...
console.log(25 ** (1 / 2)); //Sqaure root
console.log(8 ** 1 / 3); //Cubic root

console.log(Math.max(5, 12, 23, 11, 2));
console.log(Math.max(5, 12, '23', 11, 2));
console.log(Math.max(5, 12, '23px', 11, 2));

console.log(Math.min(5, 12, 23, 11, 2));

console.log(Math.PI * Number.parseFloat('10px') ** 2); // Calculate area of a cirle with 10px radius
...
console.log(Math.round(23.3)); //Rounds to next integer
console.log(Math.round(23.8));

console.log(Math.ceil(23.3)); //Removes decimal
console.log(Math.ceil(23.8));

console.log(Math.floor(23.3)); //Removes decimal
console.log(Math.floor(23.8));
console.log(Math.floor(-23.3)); //rounds to nearest
console.log(Math.floor(-23.8)); //rounds to nearest

//Rounding decimals
console.log((2.7).toFixed(0)); //toFixed returns a string
console.log((2.7).toFixed(3));
console.log((2.34533).toFixed(7));
